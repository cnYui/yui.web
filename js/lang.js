    ...
    const translations = {
        ...
        resume: {
            zh: {
                ...
                experience: '工作经历',
                job0Title: 'アニメ IP 監修 × AI 实习生',
                job0Period: '2026.9-至今',
                job0Company: 'AI Mage（东京）',
                job0Desc: 'アニメ IP × AI 方向的东京初创公司，在 IP 監修场景下做 AI 应用。',
                ...
                award7Title: '大阪 Rokid Mini Hackathon 并列第2位（準優勝）',
                award7Source: '大阪 Rokid Mini Hackathon • 2026',
            ...
            en: {
                ...
                job0Title: 'Anime IP Supervision × AI Intern',
                job0Period: '2026.9-Present',
                job0Company: 'AI Mage (Tokyo)',
                job0Desc: 'A Tokyo startup working at the intersection of anime IP and AI, building AI applications for IP supervision.',
                ...
                award7Title: 'Osaka Rokid Mini Hackathon Runner-up (Tied 2nd Place)',
                award7Source: 'Osaka Rokid Mini Hackathon • 2026',
            ...
            ja: {
                ...
                experience: '職歴',
                job0Title: 'アニメ IP 監修 × AI インターン',
                job0Period: '2026.9-現在',
                job0Company: 'AI Mage（東京）',
                job0Desc: 'アニメ IP × AI のスタートアップ（東京）。IP 監修の現場で AI を活用したアプリケーションに取り組んでいます。',
                ...
                award6Source: 'Tencent Cloud Hackathon • 2025',
                award7Title: '大阪 Rokid ミニハッカソン 同率第2位（準優勝）',
                award7Source: '大阪 Rokid ミニハッカソン • 2026',
