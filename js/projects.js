const projectData = [
    ...
    // Feb 2026
    { date: 'Feb 2026', city: 'Nanjing', images: ['/images/hackathon/tangquan-hackathon.jpg', '/images/hackathon/tangquan-poster.jpg'], title: 'Tangquan Hackathon', category: 'Hackathon', desc: 'Participated in Nanjing Tangquan Hackathon, experiencing the unique atmosphere of coding in hot springs.', link: '', badge: '' },
    // Jan 2026
    { date: 'Jan 2026', city: 'Shanghai', images: ['/images/hackathon/huanqiu-gold.jpg', '/images/hackathon/huanqiu-tea.jpg', '/images/hackathon/huanqiu-award.jpg'], title: 'Global Hackathon', category: 'Award', desc: 'Won gold award at Global Hackathon, showcasing innovative ideas.', link: '', badge: '🥇 Gold Award' },
    { date: 'Jan 2026', city: 'Online', images: ['/images/hackathon/openclaw-feishu.jpg'], title: 'OpenClaw Feishu Plugin - Crazy Thursday', category: 'Project', desc: 'Developed OpenClaw Feishu plugin for Crazy Thursday event, enhancing team collaboration efficiency.', link: '', badge: '' },
    { date: 'Jan 2026', city: 'Nanjing', images: ['/images/hackathon/nanjing-opc.jpg'], title: 'Nanjing OPC Hackathon', category: 'Hackathon', desc: 'Participated in Nanjing OPC Hackathon, exploring AI + Gaming.', link: '', badge: '' },
    // Dec 2025
    { date: 'Dec 2025', city: 'Online', images: ['/images/ai-video-comic.jpg'], title: 'AI Video/Comic Project', category: 'AI Video/Comic', desc: 'Creative AI-generated video and comic content exploring new forms of digital storytelling.', link: '', badge: '' },
    { date: 'Dec 2025', city: 'Nanjing', images: ['/images/hackathon/nanjing-mofa-hackathon.jpg'], title: 'Nanjing MoFa Hackathon', category: 'Hackathon', desc: 'Participated in the MoFa (Model Factory) Hackathon in Nanjing.', link: '', badge: '' },
    { date: 'Dec 2025', city: 'Shanghai', images: ['/images/hackathon/shanghai-christmas-hackathon.jpg'], title: 'Shanghai Christmas Hackathon', category: 'Hackathon', desc: 'Joined the festive Christmas-themed hackathon in Shanghai.', link: '', badge: '' },
    { date: 'Dec 2025', city: 'Shanghai', images: ['/images/hackathon/volcano-force.jpg'], title: 'Volcano Engine Force Conference', category: 'Meetup', desc: 'Attended the Volcano Engine Force Conference in Shanghai.', link: '', badge: '' },
    // Nov 2025
    { date: 'Nov 2025', city: 'Chongqing', images: ['/images/hackathon/渝客松Google GDG赛道第一名.jpg'], title: 'Yukesong Google GDG Track', category: 'Award', desc: 'Achieved 1st place in the Google GDG track at Yukesong hackathon.', link: '', badge: '🥇 1st Place' },
    { date: 'Nov 2025', city: 'Wuxi', images: ['/images/hackathon/无锡Rokid ARAI三等奖.jpg'], title: 'Wuxi Rokid AR AI Competition', category: 'Award', desc: 'Won 3rd place at the Wuxi Rokid AR AI competition, showcasing innovative AR applications.', link: '', badge: '🥉 3rd Place' },
    // Oct 2025
    { date: 'Oct 2025', city: 'Anhui', images: ['/images/hackathon/trae-hackathon-07.jpg'], title: 'Huikesong Hackathon', category: 'Hackathon', desc: 'Created "Suikou Chengqu" (Instant Song) project at Anhui hackathon.', link: 'http://xhslink.com/o/9pQHBf9V1Fv', badge: '' },
    // Sep 2025
    { date: 'Sep 2025', city: 'Hangzhou', images: ['/images/hackathon/yunqi-conference.jpg'], title: 'Alibaba Yunqi Conference', category: 'Meetup', desc: 'Attended the Alibaba Cloud Yunqi Conference at Yunqi Town, Hangzhou.', link: '', badge: '' },
    { date: 'Sep 2025', city: 'Online', images: ['/images/hackathon/image.png'], title: 'Tencent Cloud Online Hackathon', category: 'Award', desc: 'Pet health companion mini-program that won recognition at Tencent Cloud hackathon.', link: 'http://xhslink.com/o/ATzpS0qsjaQ', badge: '🏆 Winner' },
    { date: 'Sep 2025', city: 'Online', images: ['/images/hackathon/image copy 2.png'], title: 'n8n + Xiaohongshu MCP Auto-posting', category: 'Project', desc: 'Automated Xiaohongshu account management using n8n workflow.', link: 'https://www.xiaohongshu.com/user/profile/5b869e548bf5ee0001f35235', badge: '' },
    { date: 'Sep 2025', city: 'Online', images: ['/images/hackathon/image copy.png'], title: 'Douyin Creator Competition', category: 'Project', desc: 'Legal Theater Assistant built with Coze workflow for Douyin Creator competition.', link: 'http://xhslink.com/o/5kBv2KfGeLj', badge: '' },
    // Aug 2025
    { date: 'Aug 2025', city: 'Shanghai', images: ['/images/hackathon/trae-hackathon-08.jpg'], title: 'TRAE SOLO Hackathon Shanghai', category: 'Award', desc: 'Won 2nd place at the TRAE SOLO Hackathon Shanghai edition.', link: '', badge: '🥈 2nd Place' },
    { date: 'Aug 2025', city: 'Nanjing', images: ['/images/hackathon/trae-hackathon-05.jpg'], title: 'Nanckathon S1', category: 'Hackathon', desc: 'Participated in the Nanckathon S1 hackathon event in Nanjing.', link: '', badge: '' },
    // Jul 2025
    { date: 'Jul 2025', city: 'Nanjing', images: ['/images/hackathon/trae-hackathon-09.jpg'], title: 'TRAE Friends Nanjing', category: 'Meetup', desc: 'Technical sharing session at TRAE Friends Nanjing meetup.', link: '', badge: '' },
    { date: 'Jul 2025', city: 'Suzhou', images: ['/images/hackathon/trae-hackathon-04.jpg'], title: 'TRAE Friends Suzhou', category: 'Meetup', desc: 'Technical sharing session at TRAE Friends Suzhou meetup.', link: '', badge: '' },
    { date: 'Jul 2025', city: 'Hangzhou', images: ['/images/hackathon/trae-hackathon-01.jpg'], title: '2025 AdventureX', category: 'Hackathon', desc: 'Attended as a visitor, first close-up observation and learning experience.', link: '', badge: '' },
    // Jun 2025
    { date: 'Jun 2025', city: 'Hangzhou', images: ['/images/hackathon/trae-hackathon-02.jpg'], title: 'Trae Solo Hackathon Hangzhou', category: 'Hackathon', desc: 'Participated as a fresh graduate with WeChat mini-program experience.', link: '', badge: '' },
    // Jul 2024
    { date: 'Jul 2024', city: 'Hangzhou', images: ['/images/hackathon/AdventureX24.jpg'], title: '2024 AdventureX', category: 'Hackathon', desc: 'First time observing a hackathon as a spectator, learning from the community.', link: '', badge: '👀 First Hackathon' },
];
