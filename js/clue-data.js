...
window.YuiClueData = {
    ...
    projects: [
        ...
        { date: '2026.01', city: '线上 Online', title: 'OpenClaw 飞书插件 · 疯狂星期四', cat: 'project', desc: '为疯狂星期四活动开发 OpenClaw 飞书插件，提升团队协作效率。', img: '', award: '', link: '', rot: 1 },
        { date: '2026.01', city: '南京 Nanjing', title: '南京 OPC 黑客松', cat: 'hackathon', desc: '探索 AI + 游戏的可能。', img: '', award: '', link: '', rot: -1.5 },
        { date: '2025.12', city: '线上 Online', title: 'AI 视频 / 漫画项目', cat: 'project', desc: '用 AI 生成视频与漫画，探索数字叙事的新形态。', img: '', award: '', link: '', rot: 1 },
        ...
        { date: '2025.12', city: '上海 Shanghai', title: '上海圣诞黑客松', cat: 'hackathon', desc: '圣诞主题黑客松。', img: '', award: '', link: '', rot: 1.5 },
        { date: '2025.12', city: '上海 Shanghai', title: '火山引擎 Force 大会', cat: 'meetup', desc: '参加火山引擎 Force 大会。', img: '', award: '', link: '', rot: -1.5 },
        ...
        { date: '2025.09', city: '线上 Online', title: 'n8n + 小红书 MCP 自动发帖', cat: 'project', desc: '用 n8n 工作流自动化运营小红书账号。', img: '', award: '', link: 'https://www.xiaohongshu.com/user/profile/5b869e548bf5ee0001f35235', rot: -1 },
        { date: '2025.09', city: '线上 Online', title: '抖音创作者大赛', cat: 'project', desc: '基于 Coze 工作流的「法治剧场助手」。', img: '', award: '', link: 'http://xhslink.com/o/5kBv2KfGeLj', rot: 2 },
        ...
        { date: '2025.08', city: '南京 Nanjing', title: '南客松 S1', cat: 'hackathon', desc: '参加南京 Nanckathon S1。', img: '', award: '', link: '', rot: 1 },
        { date: '2025.07', city: '南京 Nanjing', title: 'TRAE Friends 南京', cat: 'meetup', desc: '技术分享会。', img: '', award: '', link: '', rot: -1 },
        { date: '2025.07', city: '苏州 Suzhou', title: 'TRAE Friends 苏州', cat: 'meetup', desc: '技术分享会。', img: '', award: '', link: '', rot: 1.5 },
        { date: '2025.07', city: '杭州 Hangzhou', title: '2025 AdventureX', cat: 'hackathon', desc: '以观众身份近距离观摩学习。', img: '', award: '', link: '', rot: -2 },
    ...
    travel: [
        ...
        { city: 'osaka', title: '格力高招牌', en: 'Glico Sign · Dotonbori', desc: '道顿堀的著名地标', img: CW_IMG + 'glico.webp', rot: 2 },
